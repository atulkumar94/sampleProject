...
public class CartPage extends PageObject {
	...
	public static Target purchase = Target.the("purchase button")
	...
	public static Target orderDetails = Target.the("order details")
			.located(By.xpath("//p[@class='lead text-muted ']"));
	
	public static Target okButton = Target.the("OK")
